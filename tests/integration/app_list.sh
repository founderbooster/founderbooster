...
assert_contains "$output" "- app1/dev - type=app status=published pid=4242 compose=~/demo-app"
assert_contains "$output" "- app2/prod - type=app status=unpublished pid=- compose=-"
